...
(function() {
    ...
    function createLightboxOverlay() {
        ...
        overlay.innerHTML = `
            <button class="fixed top-4 right-4 bg-black/70 border-none text-white text-3xl cursor-pointer z-10002 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-black/90 hover:scale-110" id="video-lightbox-close" aria-label="Close video">
                ×
            </button>
